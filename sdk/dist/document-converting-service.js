(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DocumentConvertingService"] = factory();
	else
		root["DocumentConvertingService"] = factory();
...
var API = function () {
    ...
    (0, _createClass3.default)(API, [{
        ...
        key: "upload",
        value: function upload(url, form) {
            return new _promise2.default(function (resolve, reject) {
                var settings = {
                    "async": true,
                    "crossDomain": true,
...
var ConvertingDocument = __webpack_require__(84);
var ConvertedDocument = __webpack_require__(90);
...
var Document = function () {
	function Document(doc_id, service_url) {
	...
	(0, _createClass3.default)(Document, [{
				...
				return _regenerator2.default.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return API.get(this.service_url + '/document/' + this.doc_id + '/meta.docs');
							...
							case 2:
								...
								_context.t0 = res_json.status;
								_context.next = _context.t0 === "converting" ? 12 : _context.t0 === "converted" ? 15 : 18;
								break;
		...
		key: 'onConvertProgress',
		value: function onConvertProgress(callback) {
		...
		key: 'page',
		value: function page(page_num, callback) {
			var _this = this;

			if (page_num <= 0 || page_num > this._pages) return callback(null);
			this._doc_logic.onPageFinished(page_num, function (types) {
				callback({
					types: types || _this._types,
					based_url: '' + _this.service_url + _this._base_url + '/page_' + page_num + '.'
				});
			});
		}
	}, {
...
var UploadJob = __webpack_require__(45);
...
var UploadJob = function () {
	function UploadJob(doc, service_url) {
		(0, _classCallCheck3.default)(this, UploadJob);

		this.doc = doc;
		this.service_url = service_url;
	}

	(0, _createClass3.default)(UploadJob, [{
		key: 'upload',
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
				var form, res;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.next = 5;
								return API.upload(this.service_url + '/upload', form);
...
var io = __webpack_require__(89);

var ConvertingDocument = function () {
	function ConvertingDocument(doc_id, serivce_url) {
		(0, _classCallCheck3.default)(this, ConvertingDocument);

		this.doc_id = doc_id;
		this.serivce_url = serivce_url;

		this.socket = io('' + serivce_url);
	...
	(0, _createClass3.default)(ConvertingDocument, [{
		key: 'clearCallbacks',
		value: function clearCallbacks() {
			this.listener = {};
		}
		...
		key: 'onPageFinished',
		value: function onPageFinished(pageNum, callback) {
		...
		value: function onUpdateProgress(callback) {
  ...
  */
		...
		key: '_onProgress',
		value: function _onProgress(last_event) {
			var _this = this;

			if (this.progress_callback != null) this.progress_callback(last_event.page_done, last_event.total_page);

			if (!this._types) this._types = last_event.types;
			this._page_done = last_event.page_done;
			this._types_pages[last_event.page_done] = last_event.types;
			(0, _keys2.default)(this.listener).map(function (pageNum) {
				if (pageNum <= last_event.page_done) {
					_this.listener[pageNum].map(function (callback) {
						callback(last_event.types);
					});
					_this.listener[pageNum] = [];
				}
			});
		}
	}]);
	return ConvertingDocument;
}();
...
var ConvertedDocument = function () {
	function ConvertedDocument(doc_id, service_url, pages) {
		(0, _classCallCheck3.default)(this, ConvertedDocument);

		this._pages = pages;
	}

	(0, _createClass3.default)(ConvertedDocument, [{
		key: "clearCallbacks",
		value: function clearCallbacks() {}
	}, {
		key: "onUpdateProgress",
...
//# sourceMappingURL=document-converting-service.js.map